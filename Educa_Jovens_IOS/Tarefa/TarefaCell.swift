...
class TarefaCell: UITableViewCell {
    ...
    private let tarefaImageView: UIImageView = {
    ...
    public func setup(tarefa: Tarefa) {
        nameLabel.text = tarefa.exer
    ...
    private func addViewInHierarchy() {
        ...
        horinzontalStack.addArrangedSubview(tarefaImageView)
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            tarefaImageView.widthAnchor.constraint(equalToConstant: 90),
            tarefaImageView.heightAnchor.constraint(equalToConstant: 120)
        ])
    }
